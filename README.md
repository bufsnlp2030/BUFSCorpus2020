...
[ZIP파일로 전체 파일 다운로드 하기](https://github.com/bufsnlp2030/BUFS-JBNUCorpus2020/archive/master.zi)
```
...
* KCC150 [KCC150_equal_morph.egg](https://github.com/bufsnlp2030/BUFS-JBNUCorpus2020/blob/master/KCC150_equal_morph.egg "클릭하면 파일을 다운로드 하는 곳으로 이동합니다.")   
  ||토큰 수 ||문장 수||
  |:------:|:------:|:------:|:------:|:------:|
