...
한국어 원시 말뭉치를 다중 언어분석기를 기반으로 하여 반자동으로 대용량 형태, 구문 대용량 말뭉치를 구축한 후 수작업으로 구문 말뭉치를 평가하였으며, 구축과정에서 형태소 분석기의 특징으로 인해 발생하는 서로 다른 분석결과를 예제를 기반으로 정규화하였다.   
그 결과 기존의 규칙기반 정규화 방식보다 토큰 단위와 문장 단위의 일치율을 향상시켰으며, 원시말뭉치중 하나인 KCC150의 성능 평가 결과 아래와 같이 형태소분석은 토큰 기준으로 99.12%, 구문분석은 토큰 기준으로 99.58%의 정확도를 가진다. 
...
정규화 후 전체 토큰 수 196,683,135(73.90%) / 전체 문장 수 __14,617,767__(77.24%)
...
정규화 후 전체 토큰 수 38,521,608(14.47%) / 전체 문장 수 __3,889,038__(20.55%)

* KCC150   
  ||토큰 수 ||문장 수||
  |:------:|:------:|:------:|:------:|:------:|
  |전체|166,904,509|-|11,961,347|-|
  |구문 분석 일치|24,428,023|__14.64%__|2,519,986|__21.07%__|

* KCC940   
  ||토큰 수 ||문장 수||
  |:------:|:------:|:------:|:------:|:------:|
  |전체|81,123,597|-|5,607,899|-|
  |구문 분석 일치|10,626,236|__13.10%__|1,023,213|__18.25%__|
  
* KCCq28   
  ||토큰 수 ||문장 수||
  |:------:|:------:|:------:|:------:|:------:|
  |전체|18,113,978|-|1,355,280|-|
  |구문 분석 일치|3,467,349|__19.14%__|345,839|__25.52%__|
